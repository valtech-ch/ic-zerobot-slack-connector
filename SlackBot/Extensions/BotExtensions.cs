...
namespace SlackBot
{
    public static class BotExtensions
    {
        ...
        public class MargieSimpleResponseChainer
        {
            ...
            public MargieSimpleResponseChainer IsDM()
            {
                Func<ResponseContext, bool> oldResponseCheck = this.Responder.CanRespondFunction;
                this.Responder.CanRespondFunction = (ResponseContext context) => { return oldResponseCheck(context) && context.Message.ChatHub.Type == SlackChatHubType.DM; };

                return this;
            }

            public MargieSimpleResponseChainer Description(string desc)
            {
                this.Responder.SetCommandDescription(desc);
                return this;
            }
        }
    }
