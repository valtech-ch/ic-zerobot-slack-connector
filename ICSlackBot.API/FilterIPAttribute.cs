...
namespace ICSlackBot.API
{
    ...
    public class FilterIPAttribute : AuthorizeAttribute
    {
        ...
        {
            // Provide default AppSettings configuration keys
            // This allows attribute to be added as: [FilterIP()]
        ...
        private bool AuthorizeCore(HttpRequestMessage httpContext)
        {
            if (httpContext == null)
                throw new ArgumentNullException("httpContext");

            string userIpAddress = HttpRequestMessageExtensions.GetClientIpAddress(httpContext);
