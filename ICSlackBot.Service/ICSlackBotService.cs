...
{
    /// <summary>
    /// IC Slack Bot Service. The bot starts and stops via Windows service
    /// </summary>
    public partial class ICSlackBotService : ServiceBase
    {
        #region vars
        private MainProgram main;
        private Timer startTimer = null;
        private static readonly ILog logger = LogManager.GetLogger(typeof(ICSlackBotService));
        #endregion

        #region Init and start
        /// <summary>
        /// Initializes a new instance of the <see cref="ICSlackBotService"/> class. Starts also the log.
        /// </summary>
        public ICSlackBotService()
        {
