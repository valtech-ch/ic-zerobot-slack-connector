...
Then simply run the Sercice from your local service list (Should be called ICSlackBot)

How to debug the Service?
When compiled as Debug, the service calls the Init after 10 seconds. That's the time you have to attach your source to the process called ICSlackBot. 